...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                 KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_BSPC  ,
                          TO(3)    , KC_LALT  , KC_LGUI  ,MO(1)     , KC_SPC   ,           KC_ENT   , MO(2)    , KC_NO    , KC_NO               , KC_NO
  ),
  ...
  [3] = LAYOUT_universal(
    KC_TAB   , KC_NO    , KC_NO    , KC_NO    , KBC_RST  , KBC_SAVE ,                                 KC_NO    , KC_NO    , KC_NO    , CPI_D100 , CPI_I100 , ACC_TOG  ,
    _______  , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,                                 SCRL_DVI , SCRL_DVD , SSNP_VRT , SSNP_HOR , SSNP_FRE , KC_NO    ,
    _______  , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,                                 KC_NO    , KC_BTN1  , KC_BTN2  , KC_NO    , SCRL_MO  , KC_NO    ,
                          TO(0)    , _______  , _______  , KC_NO    , KC_NO    ,           _______  , _______  , _______  , _______             , KC_NO
  ),
};
// clang-format on
